...
RSpec.describe SequencesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new sequence" do

        post :create, params: {sequence: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(sequence_url(Sequence.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new sequence" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the sequence" do
        sequence = Sequence.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the sequence" do
        sequence = Sequence.create! valid_attributes
